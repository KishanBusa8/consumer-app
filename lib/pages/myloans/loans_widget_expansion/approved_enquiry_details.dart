...
class ApprovedEnquiryDetails extends StatefulWidget {
  ApprovedEnquiryDetails(
      {Key? key,
  ...
  @override
  _ApprovedEnquiryDetailsState createState() => _ApprovedEnquiryDetailsState();
}

class _ApprovedEnquiryDetailsState extends State<ApprovedEnquiryDetails> {
