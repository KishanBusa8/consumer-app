...
import 'package:hashching/pages/myloans/enquiry_timeline/settled_timeline.dart';
...
class LoanEnquiryDetails extends StatefulWidget {
  LoanEnquiryDetails(
      {Key? key,
  ...
  @override
  _LoanEnquiryDetailsState createState() => _LoanEnquiryDetailsState();
}

class _LoanEnquiryDetailsState extends State<LoanEnquiryDetails> {
              ...
              if (snapshot.hasData) {
                ...
                return Container(
                    ...
                    child: ListView(shrinkWrap: true, children: [
                      ...
                      MySizedBox.height(16),
                      loanEnquireyModel.loan.allActivities.length == 0
