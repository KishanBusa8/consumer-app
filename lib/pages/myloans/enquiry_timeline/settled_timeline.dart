...
class SettledTimeline extends StatelessWidget {
  SettledTimeline({Key? key, required this.enquiryDetailsStaticModel})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    List messagebody = [
      'Congratulations, your loan has settled successfully.',
      'This section will display any updates, activity, or changes made by your broker as your loan progresses.'
    ];
    List messageHeader = ['Settled', ''];
    List messagedate = [
      "successfully-closed - ${this.enquiryDetailsStaticModel.loan.allActivities[0].createdAt}",
      ''
    ];
            ...
            return Card(
              ...
              child: Padding(
                padding: EdgeInsets.only(
                    left: 14, right: 4, top: 7, bottom: index == 2 ? 0 : 13),
                child: NewColumnMin(
