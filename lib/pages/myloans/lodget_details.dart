...
class LodgetLoanDetails extends StatelessWidget {
  LodgetLoanDetails({Key? key, required this.loanEnquireyModel})
      : super(key: key);
    ...
    return Container(
      ...
      child: NewColumn(
        ...
        children: [
          ...
          detailsHeader('Lodget Date'),
          MySizedBox.height(8),
          detailsContent(this.loanEnquireyModel!.loan.lodgedDate.toString()),
          MySizedBox.height(16),
          Row(
