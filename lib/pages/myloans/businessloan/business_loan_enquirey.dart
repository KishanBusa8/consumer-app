...
class BusinessLoanEnquirey extends StatefulWidget {
  BusinessLoanEnquirey({Key? key, required this.consumerAccountModel})
      : super(key: key);
  ConsumerAccountModel consumerAccountModel;

  @override
  _BusinessLoanEnquireyState createState() => _BusinessLoanEnquireyState();
}

class _BusinessLoanEnquireyState extends State<BusinessLoanEnquirey>
                    ...
                    TextButton(
                        onPressed: () async {
                          if (_currentPageNotifier.value == 0) {
                            ...
                            print('after   2' +
                                pageController.page!.toInt().toString());
                            if (selectContactFormkey.currentState!.validate()) {
                              if (isCheckBox) {
                                setState(() {
                                  isSubmitting = true;
                                });
  ...
  // PreferredSizeWidget linearProgressIndicator (){
  //   return PreferredSize(
  //           preferredSize: Size(MediaQuery.of(context).size.width, 1),
  //           child: Row(
  //             children: [
  //               Container(
  //                 width: MediaQuery.of(context).size.width * indicatorWidth,
