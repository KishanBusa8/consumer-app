              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    MySizedBox.height(8),
                    detailsContent(this.loanEnquiryModel.loan.approvedLoanAmount == ''
                        ? "_"
                        : this.loanEnquiryModel.loan.approvedLoanAmount.toString()),
                    MySizedBox.height(16),
                  ],
                ),
              )
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    MySizedBox.height(8),
                    detailsContent(
                        this.loanEnquiryModel.loan.closingRoi == ''
                            ? '_'
                            : this
                                .loanEnquiryModel
                                .loan
