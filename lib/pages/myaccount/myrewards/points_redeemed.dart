...
class PointsRedeemed extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(child: Text('Keep earning points to redeem your rewards for gift cards!', style: MasterStyle.blackWithSemiBoldTextStyle,textAlign: TextAlign.center,));
