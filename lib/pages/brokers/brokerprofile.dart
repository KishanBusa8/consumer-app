...
class _BrokerProfileState extends State<BrokerProfile> {
  ...
  void initState() {
    ...
    streamBrokerProfile = ApiServices.getBrokerProfileInfo(id:widget.consumerBrokers.brokerId.toString() );
  }
                  ...
                  child: Column(
                    children: [
                        ...
                        child: Container(
                          ...
                          child: CircleAvatar(
                            backgroundImage: NetworkImage(
                                widget.consumerBrokers.profilePic),
                            maxRadius: 50.r,
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: Text(
                      widget.consumerBrokers.firstName+' ' +widget.consumerBrokers.lastName,
                          style: MasterStyle.whiteTextStyleMedium.merge(TextStyle(fontWeight: FontWeight.normal)),
                        ),
                      ),
                      Container(
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                RatingBar.builder(
                                  initialRating:  4,// brokerProfileInfo.brokerDetail.rating,
                                  itemSize: 16,
                                  minRating: 1,
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          color:widget.consumerBrokers.onlineStatus?
                                           MasterStyle.customGreenColor:MasterStyle.whiteColor.withOpacity(0.6),
                                        ),
                                      ),
                                      Padding(
                                        padding: EdgeInsets.only(left: 4),
                                        child: Text(
                                        widget.consumerBrokers.onlineStatus?  'Online':'Offline',
                                          style: MasterStyle
                                              .whiteStyleRegularSmall,
                                        ),
                                      )
                                    ],
                                  ),
