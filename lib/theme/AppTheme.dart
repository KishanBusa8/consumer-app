...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    sliderTheme: SliderThemeData(
      ...
      valueIndicatorTextStyle: TextStyle(
        ...
        onBackground: Color(0xff495057)).copyWith(secondary: Color(0xff3d63ff)),
  );
  static ThemeData darkTheme = ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        iconTheme: IconThemeData(color: Color(0xffffffff), size: 24), toolbarTextStyle: darkAppBarTextTheme.bodyText2, titleTextStyle: darkAppBarTextTheme.headline6,
      ),
      cardTheme: CardTheme(
