              ...
              builder: TimelineTileBuilder.connected(
                ...
                indicatorBuilder: (_, index) {
                  ...
                  if (index == 0) {
                    ...
                    childWidget = getDotIndicatorChild(index,
                        submitToLenderIsActive, submitToLenderIsCompleted);
                  } else if (index == 3) {
                    childWidget = getDotIndicatorChild(
                        index, preApprovalIsActive, preApprovalIsCompleted);
                  } else if (index == 4) {
                    childWidget = getDotIndicatorChild(
                        index, finalApprovalIsActive, finalApprovalIsCompleted);
                  } else if (index == 5) {
                    childWidget =
                        getDotIndicatorChild(index, false, fundedIsCompleted);
                  }
                  //    if ( index <= _processIndex) {
