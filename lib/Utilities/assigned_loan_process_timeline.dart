...
class AssignedLoanProcessTimelinePage extends StatefulWidget {
  @override
  _AssignedLoanProcessTimelinePageState createState() => _AssignedLoanProcessTimelinePageState();
}

class _AssignedLoanProcessTimelinePageState extends State<AssignedLoanProcessTimelinePage> {
  int _processIndex = 2;
              ...
              builder: TimelineTileBuilder.connected(
                ...
                oppositeContentsBuilder: (context, index) => Padding(
                  ...
                  child: SvgPicture.asset(
                    ...
                    color: Colors.grey//todoColor//getColor(index),
                  ),
                ),
